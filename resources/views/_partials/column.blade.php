...
<!-- adding card -->
<div class="sticky top-32 flex flex-row items-center text-gray-900 px-2 backdrop-blur-md bg-white/30 cursor-pointer hover:bg-white/60 transition-all duration-200">
